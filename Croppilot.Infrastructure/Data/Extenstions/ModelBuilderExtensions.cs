	...
	public static class ModelBuilderExtensions
	{
		public static void SeedData(this ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Category>().HasData(
				new Category { Id = 1, Name = "Fresh Vegetables", Description = "Daily harvested organic vegetables" },
				new Category { Id = 2, Name = "Seasonal Fruits", Description = "Naturally grown fruits with authentic flavors" },
				new Category { Id = 3, Name = "Dairy Products", Description = "Fresh cheese and milk from our farm" },
				new Category { Id = 4, Name = "Organic Eggs", Description = "Free-range chicken eggs" },
				new Category { Id = 5, Name = "Ornamental Plants", Description = "Home garden flowers and decorative plants" },
				new Category { Id = 6, Name = "Seedlings", Description = "Vegetable and fruit starters for home gardening" },
				new Category { Id = 7, Name = "Organic Animal Feed", Description = "Natural feed for livestock and poultry" },
				new Category { Id = 8, Name = "Farming Tools", Description = "Essential agricultural equipment" },
				new Category { Id = 9, Name = "Premium Seeds", Description = "Certified high-yield seeds" },
				new Category { Id = 10, Name = "Organic Fertilizers", Description = "Natural soil enhancers" }
			);
