...
namespace Croppilot.Core.Featuers.Category.Query.Handlers
{
    ...
    {
        public async Task<Response<List<GetAllCategoryResponse>>> Handle(GetAllCategoryQuery request, CancellationToken cancellationToken)
        {
        ...
        {
            var category = await categoryService.GetByIdAsync(request.Id, includeProperties: "Products", cancellationToken: cancellationToken);
            if (category is null)
        ...
        public async Task<PaginatedResult<GetCategoryPaginatedResponse>> Handle(GetCategoryPaginatedQuery request, CancellationToken cancellationToken)
        {
            ...
            var categoryList = await categoryService.GetAllAsync(includeProperties: "Products", cancellationToken: cancellationToken);
