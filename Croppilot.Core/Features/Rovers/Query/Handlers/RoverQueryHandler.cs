...
public class RoverQueryHandler(IRoverService roverService) : ResponseHandler,
    ...
    IRequestHandler<GetRoverByIdQuery, Response<GetRoverResponse>>
{
    ...
    {
        var rovers = await roverService.GetRoversByUserIdAsync(query.UserId, cancellationToken);
