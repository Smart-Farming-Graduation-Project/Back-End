...
{
    public class ResetPasswordUsingOTPHandler(UserManager<ApplicationUser> userManager, IEmailService emailService) : ResponseHandler,
        IRequestHandler<ForgetPasswordUsingOTPCommand, Response<string>>
    {
