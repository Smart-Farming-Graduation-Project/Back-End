...
public class VotesController(IMediator mediator) : AppControllerBase
{
    ...
    [SwaggerOperation(Summary = "Record or update a vote",
        Description = "**Records a vote for a target (post or comment) by the authenticated user. VoteType should be 1 for upvote or -1 for downvote.**")]
    ...
    [Authorize(Policy = nameof(UserRoleEnum.User))]
    [SwaggerOperation(Summary = "Delete a vote",
