...
public class CommentsController : AppControllerBase
{
    ...
    [SwaggerOperation(Summary = "Create a new comment",
        Description = "**Creates a new comment by the authenticated user for a specified post. If the comment is a reply, provide a valid ParentCommentId; otherwise, use 0 or null.**")]
