...
public class AuthenticationController(IMediator mediator) : AppControllerBase
{
    ...
    [HttpPost("SignIn")]
    [SwaggerOperation(Summary = "Log in a user",
        Description = "**Authenticates a user and returns an access token.'عمليه تسجيل الدخول'**")]
    ...
    [SwaggerOperation(Summary = "Refreshes the authentication token",
    ...
    [SwaggerOperation(Summary = "Revokes a refresh token",
    ...
    [SwaggerOperation(Summary = "Initiates password or username recovery",
    ...
    [SwaggerOperation(Summary = "Initiates recovery using OTP",
    ...
    [SwaggerOperation(Summary = "Resets password using OTP",
    ...
    [SwaggerOperation(Summary = "Registers using a third-party provider",
        Description =
            "**Creates a user account using external authentication providers like Google or Facebook.**")]
    ...
    [SwaggerOperation(Summary = "Logs in using a third-party provider",
